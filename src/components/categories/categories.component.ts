...
import { HttpClientModule } from '@angular/common/http';
  ...
  export class CategoriesComponent implements OnInit {
    ...
    constructor(private readonly httpClient: HttpApiComponent, private dialog: MatDialog) { }
    ...
    loadCategories(){
      ...
      this.httpClient.genericHttpRequest<ICategoriesResponse[]>(endpoint,'GET', true)
        .subscribe((response) => {
    ...
    deleteCategories(category_id: string) {
      ...
      this.httpClient.genericHttpRequest(endpoint, 'DELETE', true)
    }
  }
